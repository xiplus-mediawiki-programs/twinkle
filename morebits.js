...
Morebits.wiki.page = function(pageName, currentAction) {
	...
	var fnProcessDelete = function() {
		...
		ctx.deleteProcessApi = new Morebits.wiki.api("删除页面…", query, ctx.onDeleteSuccess, ctx.statusElement, ctx.onDeleteFailure);
...
Morebits.wiki.legacyWiki = function( currentAction, query, oninit, onsuccess, onerror, onretry ) {
	...
	node.innerHTML = "<b>这个用户脚本正在使用已过时的“Morebits.wiki.legacyWiki”类来做出编辑。" +
