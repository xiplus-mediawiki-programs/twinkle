...
Twinkle.speedy.articleList = [
	{
		...
		subgroup: {
			type: 'div',
			label: $.parseHTML(wgULS('<span>这个准则近期进行了修订，请确保您所提交的内容匹配新的准则，您可以参见</span><a href="/wiki/Wikipedia_talk:快速删除方针#修訂快速刪除方針(A1)" target="_blank">该修订的讨论</a><span>。</span>', '<span>這個準則近期進行了修訂，請確保您所提交的內容符合新的準則，您可以參見</span><a href="/wiki/Wikipedia_talk:快速删除方针#修訂快速刪除方針(A1)" target="_blank">該修訂的討論</a><span>。</span>'))
		}
	},
	{
...
// Redirects
	...
	'r7': '明顯與導向目標所涵蓋的主題無關或比導向目標所涵蓋的主題更廣泛的重新導向',
// Images and media
	'f1': '重複的圖片',
	'f3': '[[:Category:未知版權的檔案]]',
	'f4': '[[:Category:來源不明檔案]]',
