...
Twinkle.speedy.articleList = [
	...
	{
		label: conv({ hans: 'A6: 复制自其他维基百科语言版本，且完全没有翻译', hant: 'A6: 與其他語言的維基項目的主內容頁面或其歷史版本重複且未翻譯的條目' }),
		value: 'a6',
		tooltip: conv({ hans: '条目符合下列所有情形：<br>1.其首个版本的内容与当时其他语言的维基项目的现存主内容页面或其历史版本的全部或部分内容完全相同或非常相似；<br>2.其当前版本的内容与其首个版本的全部或部分内容完全相同或非常相似；且<br>3.其名称不适合改为重定向。<br>此条的其他“维基项目”指维基百科、维基词典、维基教科书、维基语录、维基文库、维基物种、维基新闻、维基孵育场、维基学院等。<br>如果并不是复制于任何其他的维基百科语言版本，请换用{{notmandarin}}。<br>带有{{inuse}}和{{translating}}模板的不适用。', hant: '條目符合下列所有情形：<br>1.其首個版本的內容與當時其他語言的維基項目的現存主內容頁面或其歷史版本的全部或部分內容完全相同或非常相似；<br>2.其當前版本的內容與其首個版本的全部或部分內容完全相同或非常相似；且<br>3.其名稱不適合改為重新導向。<br>此條的其他「維基項目」指維基百科、維基詞典、維基教科書、維基語錄、維基文庫、維基物種、維基新聞、維基孵育場、維基學院等。<br>如果並不是複製於任何其他的維基百科語言版本，請換用{{notmandarin}}。<br>帶有{{inuse}}和{{translating}}模板的不適用。' }),
		subgroup: {
			name: 'a6_pagename',
			type: 'input',
			label: conv({ hans: '现有条目名：', hant: '現有條目名：' }),
	...
	},
	{
		...
		value: 'a8',
		tooltip: conv({ hans: '条目完全未用现代中文书面语撰写，适用情形包括外语、文言文与非官话白话文等。<br>属于新闻动态的条目（无论是否带有{{current}}或类似模板）不适用。<br>若条目满足草稿化的条件，且无其他构成快速删除条件的问题，则应考虑优先选择草稿化，而非快速删除。', hant: '條目完全未用現代中文書面語撰寫，適用情形包括外語、文言文與非官話白話文等。<br>屬於新聞動態的條目（無論是否帶有{{current}}或類似模板）不適用。<br>若條目滿足草稿化的條件，且無其他構成快速刪除條件的問題，則應考慮優先選擇草稿化，而非快速刪除。' })
	}
];
