...
var now = Date.now();
var timestamp = '2020年11月7日 (六) 16:26 (UTC)', ts_iso = '2020-11-07T16:26:00.000Z', naive = 20201107162600;
QUnit.test('Construction', assert => {
	...
	assert.strictEqual(new Morebits.date(timestamp).toISOString(), ts_iso, 'zhWiki timestamp format');
